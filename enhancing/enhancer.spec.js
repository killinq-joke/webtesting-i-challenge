...
describe("enhancers", () => {
  describe("repair", () => {
    ...
    it("works as expected", () => {
      expect(enhancer.repair(itemTest)).toEqual({
        name: "thing",
        durability: 100,
        enhancement: 10
      });
  ...
  describe("succeed", () => {
    ...
    it("works as expected", () => {
      expect(enhancer.succeed(itemTest)).toEqual({
        name: "thing",
        durability: 10,
        enhancement: 11
      });
      expect(enhancer.succeed(itemTest2)).toEqual({
        name: "thing",
        durability: 10,
        enhancement: 20
      });
  ...
  describe("fail", () => {
    ...
    it("works as expected", () => {
      expect(enhancer.fail(itemTest)).toEqual({
        name: "thing",
        durability: 10,
        enhancement: 5
      });
      expect(enhancer.fail(itemTest2)).toEqual({
        name: "thing",
        durability: 10,
        enhancement: 19
      });
      expect(enhancer.fail(itemTest3)).toEqual({
        name: "thing",
        durability: 10,
        enhancement: 6
      });
